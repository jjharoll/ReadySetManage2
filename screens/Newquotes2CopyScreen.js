...
const Newquotes2CopyScreen = props => {
            ...
            >
              ...
              >
                ...
                <DatePicker
                  onDateChange={newDatePickerValue => {
                    try {
                      setStartedDate(newDatePickerValue);
                    } catch (err) {
                      console.error(err);
                    }
                  }}
              ...
              >
                ...
                <DatePicker
                  onDateChange={newDatePickerValue => {
                    try {
                      setRequiredDate(newDatePickerValue);
                    } catch (err) {
                      console.error(err);
                    }
                  }}
            ...
            >
              ...
              <Stepper
                onChange={newStepperValue => {
                  ...
                  try {
                    setStepperValue2(newStepperValue);
                  } catch (err) {
                    console.error(err);
                  }
                }}
                style={StyleSheet.applyWidth(
                  { fontSize: 30, right: -200, textAlign: 'center' },
                  dimensions.width
                )}
                value={stepperValue2}
...
export default withTheme(Newquotes2CopyScreen);

  ...
  return (
    <ScreenContainer hasSafeArea={true} scrollable={false}>
      ...
      <Touchable
        onPress={() => {
          try {
            navigation.navigate('Newquotes2Screen');
          } catch (err) {
            console.error(err);
          }
        }}
      ...
      >
        {/* Cart Items */}
        <SupaBase2Api.FetchManyQuotesGET>
          {({ loading, error, data, refetchManyQuotes }) => {
...
export default withTheme(Quote2Screen);
